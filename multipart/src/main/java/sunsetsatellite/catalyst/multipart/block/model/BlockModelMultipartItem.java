...
public class BlockModelMultipartItem extends BlockModelStandard<BlockLogic> {

	public Multipart multipart;
	public boolean render3d;
	public float renderScale;

	public BlockModelMultipartItem(Block<BlockLogic> block, boolean render3d, float renderScale) {
		super(block);
