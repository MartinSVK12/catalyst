...
public class CatalystMultipart implements ModInitializer, BlockInitEntrypoint, ItemInitEntrypoint, RecipeEntrypoint {
	...
	public void afterBlockInit() {
		...
		COBBLE_NETHERRACK_MOSSY.withTags(CAN_BE_MULTIPART).withTags(tags);
		...
		ACTIVATOR_COBBLE_NETHERRACK.withTags(CAN_BE_MULTIPART).withTags(tags);
		...
		COBBLE_NETHERRACK_IGNEOUS.withTags(CAN_BE_MULTIPART).withTags(tags);
		...
		PORTAL_PARADISE.withTags(CAN_BE_MULTIPART).withTags(tags);
