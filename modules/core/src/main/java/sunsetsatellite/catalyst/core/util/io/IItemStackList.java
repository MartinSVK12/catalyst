...
public interface IItemStackList {
	 ...
	 */
	@UnmodifiableView
	List<ItemStack> addAll(List<ItemStack> stacks);
	 ...
	 * @param unlimited If <code>false</code>, amount will be limited to {@link Item#getItemStackLimit(ItemStack)} ()}
	...
	/**
	 * @param slot      Slot ID to remove from
	 * @param strict    If <code>true</code>, method fails if amount in list is not strictly {@link Item#getItemStackLimit(ItemStack)}
	 * @param unlimited If <code>false</code>, amount will be limited to {@link Item#getItemStackLimit(ItemStack)}
	 * @return The removed item stack.
	 */
	 ...
	 * @param strict    If <code>true</code>, method fails if amount in list is not strictly {@link Item#getItemStackLimit(ItemStack)} for each stack
	 * @param unlimited If <code>false</code>, amount will be limited to {@link Item#getItemStackLimit(ItemStack)} for each stack
	 ...
	 */
	@UnmodifiableView
	List<ItemStack> move(List<ItemStack> what, ItemStackList where, boolean strict);
	 ...
	 */
	@UnmodifiableView
	List<ItemStack> move(ItemStackList what, ItemStackList where, boolean strict);
