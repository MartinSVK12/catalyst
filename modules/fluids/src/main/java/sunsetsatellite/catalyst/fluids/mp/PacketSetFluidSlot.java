...
public class PacketSetFluidSlot implements NetworkMessage {
	...
	public void handle(NetworkContext context) {
		if (windowId == context.player.containerMenu.containerId && context.player.containerMenu instanceof MenuFluid) {
			((MenuFluid) context.player.containerMenu).putFluidInSlot(fluidSlot, fluidStack);
		}
	}
}
