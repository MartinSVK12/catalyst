...
public class ScreenCarpenterWorkbench extends ScreenContainerAbstract {
	...
	protected void drawGuiContainerForegroundLayer() {
		drawStringNoShadow(fontRenderer,"Carpenter Workbench", 32, 6, 0x404040);
		drawStringNoShadow(fontRenderer,"Side", 6, 24, 0x404040);
		drawStringNoShadow(fontRenderer,I18n.getInstance().translateKey("gui.crafting.label.inventory"), 8, this.ySize - 96 + 2, 4210752);

		drawStringNoShadow(fontRenderer,String.valueOf(tile.page), 150, 40, 0x404040);
	}
