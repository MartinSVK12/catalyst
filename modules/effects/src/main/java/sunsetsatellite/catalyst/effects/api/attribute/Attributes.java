...
public class Attributes extends Registry<Attribute<?>> {
	...
	public static final IntAttribute EFFECT_DURATION = (IntAttribute) new IntAttribute("attribute.catalyst-effects.effectDuration", 1).setAsDefault();

	public static IntAttribute EXTRA_HEALTH = (IntAttribute) new IntAttribute("attribute.catalyst-effects.extraHealth", 0).setAsDefault().setIcon("extra_health.png");
