...
project(":energy").projectDir = file("modules/energy")
project(":multiblocks").projectDir = file("modules/multiblocks")
project(":multipart").projectDir = file("modules/multipart")
project(":screens").projectDir = file("modules/screens")
