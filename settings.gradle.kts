val modName: Provider<String> = providers.gradleProperty("name")
...
project(":catalyst-all").projectDir = file("modules/all")
project(":catalyst-core").projectDir = file("modules/core")
project(":catalyst-effects").projectDir = file("modules/effects")
project(":catalyst-fluids").projectDir = file("modules/fluids")
project(":catalyst-energy").projectDir = file("modules/energy")
project(":catalyst-multiblocks").projectDir = file("modules/multiblocks")
